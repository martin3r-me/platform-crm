...
/**
 * Comms channel & provider-connection management (settings/admin UI).
 *
 * Extracted from ModalComms so Terminal can reuse the same CRUD logic.
 * Requires WithCommsChat (for canManageProviderConnections()).
 */
trait WithCommsChannelSettings
{
    // ── Postmark Connection ──────────────────────────────────
    ...
    /** @var array<int, array<string, mixed>> */
    public array $commsSettingsChannels = [];
    ...
    public function loadCommsSettingsChannels(): void
    {
        $this->channelsMessage = null;
        $this->commsSettingsChannels = [];
        ...
        $this->commsSettingsChannels = CommsChannel::query()
