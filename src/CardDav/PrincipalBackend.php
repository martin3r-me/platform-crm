 ...
 *
 * Principal-URI: `principals/{userId}` (passend zu {@see \Platform\Crm\CardDav\Auth\TokenAuthBackend}).
...
class PrincipalBackend implements BackendInterface
{
    ...
    {
        // Nur unser einziger Principal, und nur unter dem passenden Prefix.
