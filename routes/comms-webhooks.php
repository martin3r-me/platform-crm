...
use Platform\Crm\Http\Controllers\Comms\PostmarkDeliveryWebhookController;
...
Route::post('/postmark/delivery', PostmarkDeliveryWebhookController::class)
    ->name('crm.comms.postmark.delivery');
